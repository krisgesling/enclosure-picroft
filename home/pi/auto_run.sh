...
function setup_wizard() {
    ...
    echo "tasks easy, but is less secure.  Requiring a password will require you to"
    echo "enter your password on each system boot. Would you like to remain with the"
    echo "default setup or would you lke to enable standard 'sudo' password behavior?"
